...
<body class="">
	...
	<div align="center">
	<h1 style="margin:30px;" align="center">站方文章管理</h1>
	<div style="width:300px; margin:15px;">
		<button><a href='${pageContext.request.contextPath}/_08/contents/add'>新增站方文章</a><br></button>
	</div>
			...
			<c:forEach var='cont' varStatus='vs' items='${allcontents}'>
				...
				<tr>
					<td width='100'><img width='200' height='300'
						src="<c:url value='getContPicture/${cont.content_id}' />" /></td>
					<td>${cont.content_id}</td>
					<td>${cont.content_title}</td>
					<td>${cont.content_sub}</td>
					<td>${cont.content_fileName}</td>
					<td><a href='contents/${cont.content_id}'> Update </a></td>
