		...
		<div align="center">
			...
			<div align="center">
				...
				<form:form modelAttribute="hospital" action='hospitals'
					...
					<tr>
					<td>name:</td>
					<td><form:input path='hospital_name' /></td>
					</tr>
					<tr>
					<td>address:</td>
					<td><form:input path='hospital_address' /></td>
					</tr>
					<tr>
					<td>tel:</td>
					<td><form:input path='hospital_tel' /></td>
					</tr>
					<tr>
					<td></td>
					...
					<td></td>
					<td></td>
					<td ><a href='${pageContext.request.contextPath}/_08/admin0123'>回到管理</a></td>
					</tr>
