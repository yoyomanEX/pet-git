					...
					<div class="dropdown-menu dropdown-menu-arrow dropdown-menu-right">
						...
						<a href="${pageContext.request.contextPath}/views/profile.jsp"
							class="dropdown-item"> <i class="ni ni-single-02"></i> <span>My
								profile</span>
						</a> <a href="${pageContext.request.contextPath}/views/profile.jsp"
			...
			<div class="collapse navbar-collapse" id="sidenav-collapse-main">
				...
				<ul class="navbar-nav">
					...
					<li class="nav-item"><a class="nav-link "
						href="${pageContext.request.contextPath}/views/icons.jsp"> <i
							class="ni ni-planet text-blue"></i> Icons
					</a></li>
					<li class="nav-item"><a class="nav-link "
						href="${pageContext.request.contextPath}/views/maps.jsp"> <i
							class="ni ni-pin-3 text-orange"></i> Maps
					</a></li>
					<li class="nav-item"><a class="nav-link "
						href="${pageContext.request.contextPath}/views/profile.jsp"> <i
							class="ni ni-single-02 text-yellow"></i> User profile
					</a></li>
					<li class="nav-item"><a class="nav-link "
						href="${pageContext.request.contextPath}/views/tables.jsp"> <i
							class="ni ni-bullet-list-67 text-red"></i> Tables
					</a></li>
					<li class="nav-item"><a class="nav-link"
						href="${pageContext.request.contextPath}/views/login.jsp"> <i
		...
		<nav class="navbar navbar-top navbar-expand-md navbar-dark"
			...
			<div class="container-fluid">
				...
				<a
					...
					href="${pageContext.request.contextPath}/index.jsp">Dashboard</a>
				<!-- Form -->
				<form
				...
				<p>
					<form:form align="center"
						...
						<input type="hidden" name="id"
							value="${hospitalBean.hospital_id}${param.hospital_id}">
						...
						<Table align="center">
							...
							<TR>
								...
								<TD align="LEFT"><form:input path="hospital_name"
										size="30" /> <font color='red' size='-3'>${error.hospital_name}</font>
								</TD>
							</TR>

							<TR>
								<TD align="LEFT">ADDRESS：</TD>
								<TD align="LEFT"><form:input path="hospital_address" /> <font
									color='red' size='-3'>${error.hospital_address}</font></TD>
							</TR>
							<TR>
								<TD align="LEFT">TEL:</TD>
								<TD align="LEFT"><form:input path="hospital_tel" /> <font
									color='red' size='-3'>${error.hospital_tel}</font></TD>
							</TR>

							<TR>
								<TD colspan="2" align="center"><input type="submit"
									value="更新" name='updateBtn'
									onclick="return confirmUpdate('${hospitalBean.hospital_id}');">
