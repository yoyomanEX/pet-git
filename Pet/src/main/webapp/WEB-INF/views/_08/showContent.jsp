						...
						<nav class="navbar navbar-expand-lg navbar-light">
							...
							<div class="collapse navbar-collapse justify-content-center"
								...
								<ul class="navbar-nav">
									...
									<li class="nav-item"><a href="_08/announcements__Front"
									...
									<li class="nav-item dropdown"><a
										...
										<div class="dropdown-menu" aria-labelledby="navbarDropdown">
											<a class="dropdown-item"
												href="${pageContext.request.contextPath}/_08/hospitalsFront">醫院資訊</a>
											<a class="dropdown-item"
												href="${pageContext.request.contextPath}/_08/hotelsFront">旅館資訊</a>
											<a class="dropdown-item"
												href="${pageContext.request.contextPath}/_08/resFront">餐廳資訊</a>
