...
<!-- 		<!-- -------------------------------------------------------- --> 
<!-- 		<a href='getEmptyHotelForm'>Hotel資料新增</a><br> <a href='hotels'>Hotel資料查詢</a><br> -->
<!-- 		<br> -->
<!-- 		<!-- -------------------------------------------------------- --> 
<!-- 		<a href='getEmptyResForm'>restaurants資料新增</a><br> <a -->
<!-- 			href='restaurants'>restaurants資料查詢</a><br> <br> -->
<!-- 		<!-- -------------------------------------------------------- --> 
<!-- 		<a href='contents/add'>contents資料新增</a><br> <a href='contents'>contents資料查詢</a><br> -->
<!-- 		<br> -->
<!-- 		<!-- -------------------------------------------------------- --> 
<!-- 		<a href='announcements/add'>announcements資料新增</a><br> <a -->
<!-- 			href='announcements'>announcements資料查詢</a><br> <br> -->
<!-- 		<!-- -------------------------------------------------------- --> 
<%-- 		<a href='${pageContext.request.contextPath}/_01.loginAdminPage'>回前頁</a> --%>
<!-- 	</div> -->
	...
	<footer class="footer">
		<div class="row align-items-center justify-content-xl-between">
			<div class="col-xl-6">
				<div "copyright text-center text-xl-left text-muted">
