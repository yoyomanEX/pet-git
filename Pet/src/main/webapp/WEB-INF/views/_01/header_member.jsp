...
<script>
	...
	function NoticeClick() {
		clearInterval(Stop);
		$("#dataTotal").removeClass("badge badge-danger badge-counter")
				.html("");
	...
	function showNotice(data) {
		...
		for (i = 0; i < data.length; i++) {
			...
			if (data[i].messagestatus != null) {
				txt += '<a class="dropdown-item d-flex align-items-center" href="postblog?id='
						+ data[i].articleid
	...
	function showfriends(data) {
		var txt = "";
		for (i = 0; i < data.length; i++) {
			txt += '<a class="dropdown-item d-flex align-items-center" onclick="talk('
					+ data[i].mid
					+ ')" >'
					+ '<div class="dropdown-list-image mr-3">'
					+ '<img class="rounded-circle"'
...
<div id="wrapper">
	...
	<ul class="navbar-nav bg-gray-900 sidebar sidebar-dark accordion"
		...
		<!-- Nav Item - Dashboard -->
		<li class="nav-item active"><a href="<spring:url value='/'/>"
			class="nav-link"> <i class="fas fa-fw fa-tachometer-alt"></i> <span>PET首頁</span></a>
		</li>
			...
			<div id="collapseTwo" class="collapse" aria-labelledby="headingTwo"
				...
				<div class="bg-white py-2 collapse-inner rounded">
					...
					<a class="collapse-item" href="<spring:url value='/articlestyle'/>">
						<i class="fa fa-camera"></i>&nbsp&nbsp部落格樣式管理
					</a> <a class="collapse-item" href="<spring:url value='/article'/>">
						<i class="fa fa-paint-brush"></i>&nbsp&nbsp文章列表
					</a> <a class="collapse-item" href="<spring:url value='myblog'/>">
						<i class="fa fa-home"></i>&nbsp&nbsp我的部落格首頁
					</a>
		...
		<li class="nav-item"><a class="nav-link collapsed" href="#"
			...
			aria-expanded="true" aria-controls="collapseUtilities"> <i
				class="fa fa-child"></i><span>&nbsp&nbspPET好朋友</span>
		</a>
			<div id="collapseUtilities" class="collapse"
				aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
				<div class="bg-white py-2 collapse-inner rounded">
					<h6 class="collapse-header">&nbsp&nbsp好友清單</h6>
					<a class="collapse-item" href="friendlist"><i
						class="fa fa-users"></i>&nbsp&nbsp好友列表</a> <a class="collapse-item"
						href="application"><i class="fa fa-user-plus"></i>&nbsp&nbsp申請列表</a>
					<a class="collapse-item" href="waiting"><i
						class="fab fa-android"></i>&nbsp&nbsp等候回覆</a>
				</div>
			</div></li>
			...
			<div id="collapseOne" class="collapse"
				...
				<div class="bg-white py-2 collapse-inner rounded">
					<a href='#' class="collapse-item" onclick="room()"><i
						class="fas fa-dog"></i>&nbsp&nbsp汪汪聊天室</a> <a href='#'
						class="collapse-item" onclick="catroom()"><i
						class="fas fa-cat"></i>&nbsp&nbsp喵喵聊天室</a> <a href='#'
						class="collapse-item" onclick="petroom()"><i
		...
		<li class="nav-item"><a class="nav-link collapsed"
			href="${pageContext.request.contextPath}/06/PetOrderAll"> <i
				class="fas fa-bone"></i> <span>會員訂單</span></a></li>
			...
			<nav
				...
				<ul class="navbar-nav ml-auto">
					...
					<li class="nav-item dropdown no-arrow mx-1"><a
						...
						onclick="NoticeClick()" role="button" data-toggle="dropdown"
						aria-haspopup="true" aria-expanded="false"> <i
							class="fas fa-bell fa-fw"></i> <!-- Counter - Alerts --> <span
							id="dataTotal" class="badge badge-danger badge-counter"></span>
					</a> <!-- Dropdown - Alerts -->
						<div
							...
							<ul class="navbar-nav ml-auto">
								...
								<li class="nav-item dropdown no-arrow"><a
									...
									aria-expanded="false"> <span
										...
										style="font-size: 20px">你好，${LoginOK.name }</span> <img
										class="img-profile rounded-circle" width='60' height='60'
										src='getPicture' />
									...
									<div
										...
										<a class="dropdown-item"
											href="${pageContext.request.contextPath}/_01.memberManagement">
											<i class="fas fa-user fa-sm fa-fw mr-2 text-gray-400"></i>
											會員中心
										</a> <a class="dropdown-item" href="_01.updataMemberPage"> <i
											class="fas fa-cogs fa-sm fa-fw mr-2 text-gray-400"></i> 修改會員
										</a>
										<div class="dropdown-divider"></div>
										<a class="dropdown-item"
											href="${pageContext.request.contextPath}/_01.getLogout">
