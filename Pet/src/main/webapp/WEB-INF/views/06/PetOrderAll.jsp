...
<body id="page-top">
	...
	<div id="wrapper">
		...
		<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
			<!-- Sidebar - Brand -->
			<a class="sidebar-brand d-flex align-items-center justify-content-center" href="${pageContext.request.contextPath}/index">
			...
			<li class="nav-item">
				...
				<div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
					<div class="bg-white py-2 collapse-inner rounded">
						...
						<a class="collapse-item" href="friendlist">好友列表</a>
						<a class="collapse-item" href="application">申請列表</a>
						<a class="collapse-item" href="waiting">等候回覆</a>
					</div>
				</div>
			</li>
			<!-- Nav Item - Utilities Collapse Menu -->
			<li class="nav-item">
				...
				<div id="collapseOne" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
					<div class="bg-white py-2 collapse-inner rounded">
						<a href='#' class="collapse-item" onclick="room()">
							<i class="fas fa-dog"></i>
							汪汪聊天室
						</a>
						<a class="collapse-item" href="catroom">
							<i class="fas fa-cat"></i>
							喵喵聊天室
						</a>
						<a class="collapse-item" href="petroom">
			...
			<!-- Nav Item - Utilities Collapse Menu -->
			<li class="nav-item">
				<a class="nav-link collapsed" href="${pageContext.request.contextPath}/06/PetOrderAll">
					<i class="fas fa-paw"></i>
					<span>會員訂單</span>
				</a>
			</li>
		...
		<div id="content-wrapper" class="d-flex flex-column">
			...
			<div id="content">
				...
				<nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
					...
					<!-- Topbar Search -->
					<form action="${pageContext.request.contextPath}/findBySearch" method="post" class="d-none d-sm-inline-block form-inline mr-auto ml-md-3 my-2 my-md-0 mw-100 navbar-search">
					...
					<ul class="navbar-nav ml-auto">
						...
						<li class="nav-item dropdown no-arrow">
							<a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
								<span class="mr-2 d-none d-lg-inline text-gray-600 small">你好，${LoginOK.member_Id }</span>
					...
					<table border=1">
						<c:forEach var='list' items='${orderList}'>
							...
							<tr>
								...
								<td>${list.total}$</td>
								<c:choose>
									<c:when test="${list.paypment_status ==1}">
										<td style="color:#FF2D2D;">新訂單尚未付款</td>
									</c:when>
									<c:when test="${list.paypment_status ==2 and list.status != 3}">
										<td style="color:#FF2D2D;">已付款待出貨</td>
									</c:when>
									<c:when test="${list.paypment_status ==2 and list.status == 3}">
										<td style="color:#FF2D2D;">
											已於
											<fmt:formatDate value="${list.ship_date}" pattern="yyyy-MM-dd HH:mm"></fmt:formatDate>
											出貨
										</td >
									</c:when>
									<c:when test="${list.paypment_status ==3}">
								...
								<c:forEach var='detailList' items='${orderListDetail}'>
									<c:if test='${list.order_id == detailList.order_id}'>
										<tr orderid="${list.order_id}" style="display: none; color: #3763e6">
											<td>商品圖片</td>
											<td>商品名稱</td>
											<td>數量</td>
											<td>合計金額</td>
