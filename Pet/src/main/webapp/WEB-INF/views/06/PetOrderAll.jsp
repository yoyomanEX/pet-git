	...
	<div id="wrapper">
		...
		<ul
			...
			<a
				...
				href="${pageContext.request.contextPath}/index"> <!--         <div class="sidebar-brand-icon rotate-n-15"> -->
				...
				<div id="collapseOne" class="collapse"
					...
					<div class="bg-white py-2 collapse-inner rounded">
						<a href='#' class="collapse-item" onclick="room()"> <i
							class="fas fa-dog"></i> 汪汪聊天室
						</a> <a class="collapse-item" href="catroom"> <i
							class="fas fa-cat"></i> 喵喵聊天室
						</a> <a class="collapse-item" href="petroom"> <i
							class="fas fa-hippo"></i> PET聊天室
						</a>
					</div>
				</div></li>
			<!-- Nav Item - Utilities Collapse Menu -->
