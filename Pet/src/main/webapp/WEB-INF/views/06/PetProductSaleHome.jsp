...
<!-- Flexslider 圖片輪播套件 -->
<link href="http://cdn.bootcss.com/flexslider/2.6.3/flexslider.min.css"
	rel="stylesheet">
...
<script
	src="http://cdn.bootcss.com/flexslider/2.6.3/jquery.flexslider.min.js"></script>
	...
	<div id="pageBackground">
		...
		<div id="content">
			<div class="flexslider">
				<ul class="slides">
					<li><img class="imgBanner"
						src="${pageContext.request.contextPath}/06/img/saleBanner01.png"
						alt="" style="height: 550px; width: 800px"></li>
					<li><img class="imgBanner"
						src="${pageContext.request.contextPath}/06/img/saleBanner02.png"
						alt="" style="height: 550px; width: 800px"></li>
					<li><img class="imgBanner"
						src="${pageContext.request.contextPath}/06/img/saleBanner03.png"
						alt="" style="height: 550px; width: 800px"></li>
				</ul>
			</div>
		</div>
