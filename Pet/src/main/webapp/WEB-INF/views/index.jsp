			...
			<div class="row justify-content-center">
				<div class="col-lg-8">
					<div class="section_tittle text-center">
						...
						<p>Working in conjunction with humanitarian aid agencies, we
							have supported programmes to help alleviate human suffering
							through animal welfare when people might depend.</p>
					</div>
				</div>
			</div>
			<div class="row">
				...
				<div class="col-lg-4 col-sm-6">
					...
					<div>
						<ul class="follow">
							<li class="follow__icon"><a
								class="follow__icon--link icon--line gtm_menu_follow_us_instagram"
								href="https://www.instagram.com/" target="_blank"></a></li>
							<li class="follow__icon"><a
								class="follow__icon--link icon--fb gtm_menu_follow_us_fb"
								href="https://www.facebook.com/" target="_blank"></a></li>
							<li class="follow__icon"><a
								class="follow__icon--link icon--youtube gtm_menu_follow_us_youtube"
								href="https://www.youtube.com/" target="_blank"></a></li>
							<li class="follow__icon"><a
								class="follow__icon--link icon--instagram gtm_menu_follow_us_robot"
				...
				<div class="col-md-5">
					<div class="about_text">
						...
						<div>
							<ul class="follow">
								<li class="follow__icon"><a
									class="follow__icon--link icon--instagram gtm_menu_follow_us_instagram"
									href="https://www.instagram.com/" target="_blank"></a></li>
								<li class="follow__icon"><a
									class="follow__icon--link icon--fb gtm_menu_follow_us_fb"
									href="https://www.facebook.com/" target="_blank"></a></li>
								<li class="follow__icon"><a
									...
									target="_blank"></a></li>
								<li class="follow__icon"><a
									class="follow__icon--robot icon--robot gtm_menu_follow_us_robot"
									href="#" target="_blank"></a></li>
							</ul>
						</div>
					</div>
			...
			<div class="row">
				<div class="col-lg-12">
					<div class="copyright_text">
						<img src="img/about_icon.png" alt="#"><span>pET ʕ•ᴥ•ʔ
							陪你</span>
						<p class="footer-text">
							Copyright &copy;
							<script>
