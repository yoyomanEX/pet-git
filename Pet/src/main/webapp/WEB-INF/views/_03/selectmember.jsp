									...
									<div class="card-body">
										<div class="row no-gutters align-items-center">
											<div class="col mr-2">
												...
												<div class="h5 mb-0 font-weight-bold text-gray-800">${friend.member_Id}</div>
											</div>
											<table>
												<tr>
													<td><form action='add' method="post">
															<input type="hidden" name='friendid'
																value='${friend.member_Id}'> <input
																type="submit" value='申請好友'>
														</form></td>
												</tr>
											</table>
											<div class="col-auto">
												<img class="rounded-circle" width="60" height="60"
											src="getMbPicture/${friend.member_Id}" alt="">
											</div>
